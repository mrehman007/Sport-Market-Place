...
export class Marketplace__getPlatformFeeInfoResult {
  value0: Address;
  value1: i32;
...
export class Marketplace__winningBidResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: Address;
...
export class Marketplace extends ethereum.SmartContract {
  ...
  getPlatformFeeInfo(): Marketplace__getPlatformFeeInfoResult {
    let result = super.call(
      "getPlatformFeeInfo",
    ...
    return new Marketplace__getPlatformFeeInfoResult(
      result[0].toAddress(),
      result[1].toI32()
    );
  }
  ...
  try_getPlatformFeeInfo(): ethereum.CallResult<
    Marketplace__getPlatformFeeInfoResult
  > {
    let result = super.tryCall(
      "getPlatformFeeInfo",
      "getPlatformFeeInfo():(address,uint16)",
    ...
    return ethereum.CallResult.fromValue(
      new Marketplace__getPlatformFeeInfoResult(
        value[0].toAddress(),
        value[1].toI32()
      )
    );
  ...
  offers(param0: BigInt, param1: Address): Marketplace__offersResult {
    let result = super.call(
      "offers",
  ...
  winningBid(param0: BigInt): Marketplace__winningBidResult {
    let result = super.call(
      "winningBid",
    ...
    return new Marketplace__winningBidResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toAddress(),
  ...
  try_winningBid(
    param0: BigInt
  ): ethereum.CallResult<Marketplace__winningBidResult> {
    let result = super.tryCall(
      "winningBid",
      "winningBid(uint256):(uint256,address,uint256,address,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Marketplace__winningBidResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toAddress(),
