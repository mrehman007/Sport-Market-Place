...
export async function getServerSideProps(context) {
  try {
    ...
    const res = await fetch(`${protocol}://${host}/api/cache?page=auctions`);
...
export default function Auctions({ cacheData }) {

  const { globalStateChanged, isLoading } = useContext(GlobalContext);
  ...
  return (
    <>
      <Head>
        <title>Fantasy Sports | Auctions Marketplace</title>
